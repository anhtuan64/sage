				...
				if ( $blog_layout == 'grid' ||
					...
					echo '<div class="fusion-post-content post-content">';
						...
						if( !empty( $e_date ) || !empty( $e_time ) || !empty( $e_adress ) || !empty( $e_detail_adress ) || !empty( $e_fees ) ) :
							echo '<div class="information-event">';
							if( !empty( $e_date ) || !empty( $e_time ) ) :
								echo '<p class="e_date_time"><i class="fa fa-caret-square-o-right"></i>';
								if( !empty( $e_date ) ) : 
									echo '<span class="e-date">'.$e_date.'</span>';
								endif;
								if( !empty( $e_time ) ) : 
									echo '<span class="e_time">'.$e_time.'</span>';
								endif;
								echo '</p>';
							endif;
							if( !empty( $e_adress ) ) : 
								echo '<p class="e_adress"><i class="fa fa-map-marker"></i>'.$e_adress.'</p>';
							endif;
							if( !empty( $e_detail_adress ) ) : 
								echo '<p class="e_detail_adress"><i class="fa fa-paper-plane"></i>'.$e_detail_adress.'</p>';
							endif;
							if( !empty( $e_fees ) ) : 
								echo '<p class="e_fees"><i class="fa fa-usd"></i>'.$e_fees.'</p>';
							endif;
							echo '</div>';
						endif;
